...
var printDocASTReducer = {
  ...
  VariableDefinition: {
    leave: ({ variable, type, defaultValue, directives }) => variable + ": " + type + wrap3(" = ", defaultValue) + wrap3(" ", join(directives, " "))
  },
  SelectionSet: {
  ...
  // Fragments
  FragmentSpread: {
    leave: ({ name, directives }) => "..." + name + wrap3(" ", join(directives, " "))
  },
  InlineFragment: {
  ...
  FragmentDefinition: {
    leave: ({ name, typeCondition, variableDefinitions, directives, selectionSet }) => (
      ...
      `fragment ${name}${wrap3("(", join(variableDefinitions, ", "), ")")} on ${typeCondition} ${wrap3("", join(directives, " "), " ")}` + selectionSet
    )
  },
  // Value
  IntValue: {
  ...
  // Directive
  Directive: {
    leave: ({ name, arguments: args }) => "@" + name + wrap3("(", join(args, ", "), ")")
  },
  // Type
  NamedType: {
    leave: ({ name }) => name
  ...
  UnionTypeDefinition: {
    leave: ({ description, name, directives, types }) => wrap3("", description, "\n") + join(
      ["union", name, join(directives, " "), wrap3("= ", join(types, " | "))],
      " "
    )
  },
  EnumTypeDefinition: {
...
//# sourceMappingURL=chunk-F5FV4CPG.js.map
